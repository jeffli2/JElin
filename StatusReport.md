...
On November 12, Elin had finished working on the remaining data cleaning components needed to support the analysis process.
...
November 1-16: In this time period, Elin was working on data cleaning procedures needed throughout the project.
...
We also decided to have both of us work on different tasks at the same time instead of one after another. This saved us time and helped us finish the analysis earlier than expected. We added some extra automation tools (GitHub Actions) that weren't in our original plan to make the project easier to reproduce.
